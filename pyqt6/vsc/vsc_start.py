...
class myapp(QMainWindow):
    ...
    def make_menu(self):
        ...
        self.add_act('뒤로')
        self.add_act('앞으로')
        self.add_act('마지막 편집위치')
        self.add_sep()

        self.add_submenu('편집기 전환') 
        self.add_submenu('그룹 전환')
        self.add_sep()

        self.add_act_ctrl('파일로 이동','P') 
        self.add_act_ctrl('작업영역의 기호로 이동','T')
        self.add_sep()

        self.add_act_shift2('편집기의 기호로 이동','O')
        self.add_act('정의로 이동') 
        self.add_act('선언으로 이동')
        self.add_act('형식 정의로 이동')
        ...
        self.add_menu('도움말','H')
        self.add_act('시작하기')
        self.add_act_shift2('모든 명령 표시','P')
        self.add_act('편집기 플레이그라운드')
        self.add_act('설명서')
        self.add_act('릴리스 정보표시')
        self.add_sep()
        self.add_act_ctrl('바로가기키 참조','K')
        self.add_act('비디오 자습서')
        self.add_act('팁과 요령')
